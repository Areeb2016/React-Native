...
import { Container, Header, Content, Card, CardItem, Thumbnail, Text, Button, Icon, Left, Body, Right, Title, Item, DatePicker } from 'native-base';
    ...
    render() {
      ...
      return (
        <Container>
          ...
          <Content>
          <View style={{flexDirection:'row', backgroundColor:"#FD9A24"}}>
